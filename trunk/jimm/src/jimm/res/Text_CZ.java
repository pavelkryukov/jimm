...
public class Text_CZ extends ResourceBundle
{
	...
	public Text_CZ()
	{
		...
		resources.put("display_advertisement",       "Pripojit Jimm tip?");
		...
		resources.put("lang_BR",                     "Portugalštine Brazilské");
		resources.put("lang_CZ",                     "Cesky");
		resources.put("lang_DE",                     "Nemecky");
		resources.put("lang_EN",                     "Anglicky");
		resources.put("lang_ES",                     "Španelsky");
		...
		resources.put("not_implemented",             "Funkce není zprovoznena.");
		...
		resources.put("options_account",             "Úcet");
		resources.put("options_cost",                "Poplatky");
		resources.put("options_effect",              "Musíte se nove pripojit aby se nekteré zmeny projevily!");
		resources.put("options_interface",           "Zobrazení/zvuk");
		resources.put("options_network",             "Sít");
		...
		resources.put("status_occupied",             "Zaneprázdnen");
		resources.put("status_offline",              "Odpojen");
		resources.put("status_online",               "Pripojen");
		...
		resources.put("error_110",                   "Vícenásobné prihlášení stejným UIN (#110.EXT)");
		resources.put("error_111",                   "Špatné heslo (#111.EXT)");
		resources.put("error_112",                   "Neexistující UIN (#112.EXT)");
		resources.put("error_113",                   "Príliš mnoho klientu stejného IP (#113.EXT)");
		resources.put("error_114",                   "Prekrocení rychlosti (#114.EXT)");
		resources.put("error_115",                   "Seznam kontaktu nelze precíst (#115.EXT)");
		resources.put("error_116",                   "Offline zprávy nelze precíst (#116.EXT)");
		resources.put("error_117",                   "Nevyplnen UIN a/nebo heslo (#117.EXT)");
		...
		resources.put("error_121",                   "Požadované TCP spojení nelze vytvorit (#121.EXT)");
		...
		resources.put("error_130",                   "FLAP-Záhlaví nemuže být zpracováno (#130.EXT)");
		resources.put("error_131",                   "Neznámý kanál (#131.EXT)");
		resources.put("error_132",                   "Paket na pripojeném kanálu nemuže být zpracován (#132.EXT)");
		resources.put("error_133",                   "SNAC-Záhlaví nemuže být zpracováno (#133.EXT)");
		resources.put("error_134",                   "Paket na chybovém kanálu nemuže být zpracován (#134.EXT)");
		resources.put("error_135",                   "Paket na Disconnect-kanálu nemuže být zpracován (#135.EXT)");
		resources.put("error_136",                   "Paket na Ping-kanálu nemuže být zpracován (#136.EXT)");
		resources.put("error_137",                   "Starší záhlaví ICQ-Protokolu nemuže být zpracováno (#137.EXT)");

		// Action errors
		resources.put("error_140",                   "Požadovaná akce nemuže být nyní zarazena do zpracování (#140.EXT)");

		// Specific action errors
		resources.put("error_150",                   "Prijatá zpráva byla nesrozumitelná (#150.EXT)");
		resources.put("error_151",                   "Prijatá zpráva tipu 1 byla nesrozumitelná (#151.EXT)");
		resources.put("error_152",                   "Prijatá zpráva tipu 2 byla nesrozumitelná (#152.EXT)");
		resources.put("error_153",                   "Prijatá zpráva tipu 4 byla nesrozumitelná (#153.EXT)");
