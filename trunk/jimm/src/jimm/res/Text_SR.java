...
public class Text_SR extends ResourceBundle
{
  ...
  public Text_SR()
  {
    ...
    // Labels
		...
		resources.put("add_user",                    "Додај корисника");
		...
		resources.put("conn_type",                   "Тип конекције");
		...
		resources.put("display_advertisement",       "Прикажи Јимм савет?");
		...
		resources.put("keep_conn_alive",             "Одржавај конекцију?");
		resources.put("keylock_enable",              "Закључај тастере");
		resources.put("keylock_enabled",             "Тастери закључани");
		resources.put("keyword",                     "Кључно слово");
		resources.put("language",                    "Језик");
		...
		resources.put("lang_IT",                     "Италијански");
		...
		resources.put("msg_sound_file_name",         "Фајл са звуком за поруку");
		...
		resources.put("options",                     "Опције");
		resources.put("options_account",             "Налог");
		resources.put("options_cost",                "Цена");
		resources.put("options_effect",              "Морате да се реконектујете да би измене биле примљене!");
		...
		resources.put("requno",                      "Није потребно");
		...
		resources.put("sort_by",                     "Сортирај контакте");
		...
		resources.put("status_dnd",                  "Не узнемиравај");
		...
		resources.put("user_add",                    "Додај корисника");
    ...
    // Parsing specific errors
		...
		resources.put("error_135",                   "Дисконекција из канала нечитљива (#135.EXT)");
    ...
    // Specififc action errors
		...
		resources.put("error_153",                   "Примљена порука типа 4 није разумљива (#153.EXT)");
		resources.put("error_154",                   "Учитавање контаката није успело (#154.EXT)");
		resources.put("error_155",                   "Објекат је већ на Вашој листи сервера (#155.EXT)");
		resources.put("error_156",                   "Грешка приликом додавања. Покушајте поново (#156.EXT)");
		resources.put("error_157",                   "Није дозвољено више елемената овог типа (#157.EXT)");
