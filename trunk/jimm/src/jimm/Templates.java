...
public class Templates implements VirtualListCommands, CommandListener
{
	...
	private static Command deleteTemplateCommand = new Command(ResourceBundle.getString("delete"), Command.ITEM, 4);
	private static Command clearCommand = new Command(ResourceBundle.getString("clear"), Command.ITEM, 5);
	
	private static Command addCommand = new Command(ResourceBundle.getString("add_new"), Command.OK, 1);
	...
	public static void selectTemplate(CommandListener selectionListener_, Displayable lastDisplay_)
	{
	...
	private static void refreshList()
	{
		...
		for ( int i = 0; i < getRecordCount(); i++)
			templateList.addBigText(getRecord(i),templateList.getTextColor(),Font.STYLE_PLAIN,i).doCRLF(i);
		templateList.unlock();
	}
