...
public class Text_RU extends ResourceBundle
{
	...
	public Text_RU()
	{
		...
		resources.put("remove_me",                   "Удалить меня из контактлиста пользователя"); 
		resources.put("remove_me_from",              "Удалить меня из контакт листа ");
		...
		resources.put("reqstatmsg",                  "Статусное сообщение");
